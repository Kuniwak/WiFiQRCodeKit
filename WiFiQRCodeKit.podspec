#
#  Be sure to run `pod spec lint WiFiQRCodeKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Kuniwak"
  # s.authors            = { "Kuniwak" => "orga.chem.job@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Kuniwak"
  ...
  s.source       = { :git => "https://github.com/Kuniwak/WiFiQRCodeKit.git", :tag => "#{s.version}" }
